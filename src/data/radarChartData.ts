...
// Min/max values from the FULL database (4,362 rows) for proper normalization
// These values are extracted from Democracy_Data.db to match Streamlit exactly
...
// EDI range from the full database (for percentile calculations)
export const EDI_RANGE = { min: 0.015, max: 0.923 };
